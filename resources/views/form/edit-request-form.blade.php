            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div x-data="{
                        ...
                        <template x-for="(item, index) in items" :key="index">
                            <div class="flex gap-3 mb-3 items-center">
                                <input type="text" :name="`items[${index}][name]`" x-model="item.name"
                                       ...
                                       class="w-full h-10 px-3 rounded-md border-gray-300 shadow-sm" required>
                                <input type="number" :name="`items[${index}][quantity]`" x-model="item.quantity"
                                       min="1"
                                       class="w-24 h-10 px-2 rounded-md border-gray-300 shadow-sm" required>
                        ...
                        <p x-show="items.length >= maxItems" class="text-xs text-red-500 mt-1">
                ...
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <x-text-input id="users" class="block mt-1 w-full" type="number" name="users"
