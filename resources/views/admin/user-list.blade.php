...
<div class="request-history-list w-full rounded-xl shadow overflow-hidden">
...
<div class="head bg-blue-100 dark:bg-blue-900 px-4 py-2 flex text-sm font-semibold text-gray-700 dark:text-gray-200 rounded-t-xl">
    ...
    <div class="w-3/12 text-center">Name</div>
    <div class="w-3/12 text-center">Email</div>
    <div class="w-2/12 text-center">Created</div>
    <div class="w-1/12 text-center">Status</div>
    <div class="w-2/12 text-center">Actions</div>
</div>
...
<div class="request-history-wrapper divide-y divide-gray-200 dark:divide-gray-700">
    ...
    <div class="row flex items-center px-6 py-3 text-sm">
                    ...
                    <div class="w-1/12 text-center text-gray-600 dark:text-gray-300">
                    {{ $user->id }}
                </div>

                    <div class="w-3/12 text-center text-gray-800 dark:text-gray-200">
                    {{ $user->name }}
                </div>

                    <div class="w-3/12 text-center text-gray-600 dark:text-gray-300">
                    {{ $user->email }}
                </div>
                ...
                <div class="w-1/12 flex justify-center">
                    @if($user->deleted_at)
                        <span class="text-gray-600 dark:text-gray-300 px-3 py-1 rounded-full text-xs font-medium">
                            Deleted
                        </span>
                ...
                <div class="w-2/12 flex justify-center gap-2"
